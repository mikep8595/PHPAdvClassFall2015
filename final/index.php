...
/**
 * TODO:
 * Pages needed for Signup / Login + Functionality for that. May be able to receylce that from previous projects.
 * -Users can use meme generated photos without having to login.
 * -Only logged in users can upload an image when they want.
 * When uploaded, save the image and link it to the user who uploads it.
 * Should be able to share a meme image by email or social media.
